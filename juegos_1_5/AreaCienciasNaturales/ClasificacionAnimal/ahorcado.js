...
function mensaje_final(tipo){
  if(tipo == 1){
    Swal.fire({
      position: "center",
      imageUrl: "../../images/ciencia/correcto.gif",
      imageWidth: 250,
      imageHeight: 250,
      title: "Correcto!",
    ...
    Swal.fire({
      position: "center",
      imageUrl: "../../images/ciencia/incorrecto.gif",
      imageWidth: 250,
      imageHeight: 250,
      title: "Incorrecto!",
...
function elegir(){
    Swal.fire({
    title: 'Selecciona una Categoria relacionada con el tema <br> (Clasificación de los animales)',
    icon: 'info',
    html: '<div style="padding-top: 20px"  class="row">'+
      '<div class="col-4"><div><img onclick="seleccionar(this, 1)" class="imagen_Vocal" src="img/estructura.png" alt=""></div></div>'+
      '<div class="col-4"><div><img onclick="seleccionar(this, 2)" class="imagen_Vocal" src="img/alimentacion.png" alt=""></div></div>'+
      '<div class="col-4"><div><img onclick="seleccionar(this, 3)" class="imagen_Vocal" src="img/reproduccion.png" alt=""></div></div>'+
		'</div>',
...
function seleccionar(elemento, tipo) {
  ...
  switch (tipo) {
    case 1:
      palabras = interprete_bp.clasificacion_estructura;
    break;
    case 2:
      palabras = interprete_bp.clasificacion_alimentacion;
    break;
    case 3:
      palabras = interprete_bp.clasificacion_reproduccion;
    break;
    default:
      break;
  }
