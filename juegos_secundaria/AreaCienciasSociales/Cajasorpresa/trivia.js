...
function iniciarTrivia(tema,idTem){
...
next_btn.onclick = ()=>{
    if(nPreg <= 11){ //if question count is less than total question length
        que_count = obtenerIndiceAleatorio();
...
function queCounter(index){
    ...
    let totalQueCounTag = '<span><p>'+ index +'</p> de <p>10</p> Preguntas</span>';
