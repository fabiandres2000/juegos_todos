...
function siguientePregunta() {
  ...
  if (conse <= 27) {
    ...
    var div_letra = document.getElementById(letraActual);
    div_letra.classList.add("actual_r");
...
function verificarRespuesta(){
  ...
  const letras = Object.keys(preguntas["preguntas"]);
  var div_letra = document.getElementById(letras[conse-1]);
  if(respuesta==respuestaPreg){
    respuesta_correcta++;
    document.getElementById("respuesta").style.backgroundColor="#71d90b";
    div_letra.classList.remove("actual_r");
    div_letra.classList.add("correcta_r");
    ...
    div_letra.classList.remove("actual_r");
    div_letra.classList.add("incorrecta_r");
