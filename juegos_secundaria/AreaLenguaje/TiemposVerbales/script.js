...
function llenarArray() {
    if (pregunta_actual < 5) {
        ...
        document.getElementById("tipo_frase").innerText = elemento.tipo;
        ...
        for (let index = 0; index < elemento.opciones.length; index++) {
            ...
            div +=
                ...
                element[1] +
                "'>" +
                "<div style='justify-content: center; height: 50pt; text-align: center; display: flex;align-items: center;width: 50%;'><h2>" + element[0] + "</h2></div>" +
                "</div>";
        }
...
$(document).ready(function () {
    let base_preguntas = readText("data.json");
