...
Winwheel.prototype.drawSegments = function () {
  if (this.ctx && this.segments)
    for (x = 1; x <= this.numSegments; x++) {
      ...
      b = null !== seg.strokeStyle ? seg.strokeStyle : this.strokeStyle;
          ...
          a =
            ...
            n =
              null !== seg.textDirection
                ? seg.textDirection
                : this.textDirection,
            f = null !== seg.textMargin ? seg.textMargin : this.textMargin,
            k =
              ...
              if ("outer" == e)
                for (d = a[i].length - 1; 0 <= d; d--)
                  (character = a[i].charAt(d)),
                    k && this.ctx.fillText(character, this.centerX + c, h),
...
Winwheel.prototype.getSegmentAt = function (a, b) {
  var c = null,
    l = this.getSegmentNumberAt(a, b);
  null !== l && (c = this.segments[l]);
  return c;
};
Winwheel.prototype.getSegmentNumberAt = function (a, b) {
  var c = this.windowToCanvas(a, b),
    ...
    f;
  c.x > this.centerX
    ? ((n = c.x - this.centerX), (e = "R"))
    : ((n = this.centerX - c.x), (e = "L"));
  c.y > this.centerY
    ? ((f = c.y - this.centerY), (l = "B"))
    : ((f = this.centerY - c.y), (l = "T"));
...
function winwheelAnimationLoop() {
  winwheelToDrawDuringAnimation &&
    ...
    null != winwheelToDrawDuringAnimation.animation.callbackBefore &&
      eval(winwheelToDrawDuringAnimation.animation.callbackBefore),
    winwheelToDrawDuringAnimation.draw(!1),
    null != winwheelToDrawDuringAnimation.animation.callbackAfter &&
...
function winwheelStopAnimation(a) {
  0 != a &&
    null != winwheelToDrawDuringAnimation.animation.callbackFinished &&
